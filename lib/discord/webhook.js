...
class DiscordEmbed {
	 ...
	 * @param {string | Array<number>} color - The color of the payload. This can be a string representing a color name or a hexadecimal value, or an array of RGB or RGBA values.
	 */
	setColor(color) {
		this.payload.embeds.color = color;
	}
